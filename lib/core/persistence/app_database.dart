...
class AuditTrail extends Table {
  ...
  TextColumn get beforeHash => text()
      .named('before_hash')
      .withLength(min: 64, max: 64)
      .nullable()();

  TextColumn get afterHash => text()
      .named('after_hash')
      .withLength(min: 64, max: 64)
      .nullable()();

  TextColumn get redactedSnapshot => text()
      .named('redacted_snapshot')
      .withLength(max: 8000)
      .nullable()();
...
class AgentRuns extends Table {
  ...
  TextColumn get taskCardId => text()
      .named('task_card_id')
      .withLength(min: 1, max: 120)
      .nullable()();
...
class ApprovalRecords extends Table {
  ...
  TextColumn get approvalType => text()
      .named('approval_type')
      .withLength(min: 1, max: 80)();
  ...
  TextColumn get decisionNote => text()
      .named('decision_note')
      .withLength(max: 4000)
      .nullable()();
  ...
  TextColumn get obsidianRefId => text()
      .named('obsidian_ref_id')
      .withLength(min: 1, max: 120)
      .nullable()();
...
/// Minimal generated Drift database for early persistence schema slices.
///
/// Approved schema slices only:
/// - [AppSettings]
/// - [ObsidianReportRefs]
/// - [AuditTrail]
/// - [Missions]
...
/// - [ApprovalRecords]
///
/// Explicitly not included in this slice: Activity Events, QA Evidence Links,
/// Secret Refs, repositories, CRUD services, Riverpod/UI wiring,
/// backup/export/restore, secure storage, or real data.
@DriftDatabase(
  tables: [
    AppSettings,
    ObsidianReportRefs,
