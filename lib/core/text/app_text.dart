...
abstract final class AppText {
  ...
  static const premiumHomeTitle = '린님 Mission Command';
  static const premiumHomeCaption =
      'AI에게 지시하고, 오늘의 미션·우선순위·다음 행동을 한눈에 보는 첫 화면입니다.';
  static const premiumHomeCommandKicker = '오늘의 중심 명령';
  static const premiumHomeCommandTitle = '신규 LLM 배포 흐름 점검';
  static const premiumHomeCommandBody =
      '명령 실행 전, 필요한 준비·검수·기록 흐름을 정적 화면에서 먼저 확인합니다.';
  static const premiumHomeCommandReady = '명령 준비';
  static const missionCommandTitle = '미션 커맨드';
  static const missionCommandSearch = '명령 검색';
  static const missionCommandGovernanceButton = '거버넌스';
  static const missionCommandExecuteReady = '명령 준비';
  static const missionCommandOverview = '운영 개요';
  static const missionCommandActive = '진행 중 미션';
  static const missionCommandWaiting = '대기 미션';
  static const missionCommandDone = '완료 미션';
  static const missionCommandReliability = '성공률';
  static const missionCommandLoad = '시스템 부하';
  static const missionCommandSelectedMission = '선택된 미션';
  static const missionCommandMissionId = '#M-250519-11';
  static const missionCommandSelectedTitle = '신규 LLM 배포 및 성능 검증';
  static const missionCommandSelectedTag = 'AI 모델 운영';
  static const missionCommandProgress = '진행률 50%';
  static const missionCommandNextStep = '다음 행동: 성능 벤치마크 확인';
  static const missionCommandStaticNote = '정적 미리보기 · 실행 없음';
  ...
  static const premiumHomeModuleDockCaption =
      '모듈은 조용한 dock으로 낮추고, 명령 흐름을 먼저 둡니다.';
