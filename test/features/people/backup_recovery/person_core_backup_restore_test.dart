...
void main() {
  ...
  test(
    'Person-only schema v11 backup validates and restores synthetic rows',
    () async {
  ...
  test(
    'exact v6 backup is migrated in isolation and restored as v11 with empty groups',
    () async {
  ...
  test('v11 round trip preserves linked manual null self and archive', () async {
    final counts = await roundTrip(
      includePerson: true,
      includeTarot: true,
